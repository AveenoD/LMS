...
class TimetableScreen extends ConsumerWidget {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Weekly class schedule by batch',
                    style: TextStyle(
                ...
                child: timetableAsync.when(
                  ...
                  data: (timetable) {
                    if (timetable.isEmpty)
                      return const Center(child: Text('No scheduled classes.'));
  ...
  Future<void> _openScheduleBottomSheet(
    ...
    if (batches.isEmpty || teachers.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'You need at least one batch and one teacher before scheduling a class.',
          ),
        ),
      );
      return;
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _ScheduleClassBottomSheet(
        batches: batches,
        teachers: teachers,
        subjects: subjects,
      ),
...
class _ScheduleClassBottomSheet extends ConsumerStatefulWidget {
  ...
  const _ScheduleClassBottomSheet({
  ...
  @override
  ConsumerState<_ScheduleClassBottomSheet> createState() =>
      _ScheduleClassBottomSheetState();
}

class _ScheduleClassBottomSheetState
    extends ConsumerState<_ScheduleClassBottomSheet> {
  int? _batchId;
  int? _teacherId;
  int? _subjectId;
  int _dayOfWeek =
      DateTime.now().weekday %
      7; // DateTime: Mon=1..Sun=7 -> convert to 0=Sun..6=Sat
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<int>(
                      ...
                      onChanged: (v) =>
                          setState(() => _dayOfWeek = v ?? _dayOfWeek),
                    ),
                    const SizedBox(height: 16),
                    Row(
                      children: [
