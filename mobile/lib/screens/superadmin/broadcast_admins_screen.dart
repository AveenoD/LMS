...
class BroadcastAdminsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BroadcastAdminsScreen> createState() => _BroadcastAdminsScreenState();
}
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Sent to $count admin(s).')),
        );
        _title.clear();
        _body.clear();
        _city.clear();
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(label: 'Title', hint: 'e.g. Platform maintenance tonight', controller: _title),
